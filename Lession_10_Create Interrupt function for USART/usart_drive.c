...
void USART_Send( unsigned short usart, unsigned short usart_target,unsigned short same_baud, unsigned short *recieved_signal, char str[], unsigned short *counter )
{
	if (same_baud == 0) {
	...
	USART_TX(usart_target, USART_RX(usart));
